...
Attach a copy of this schedule to your return. For more information, see line 
222 in the guide. 
...
Line 4: Enter the amount from box 26 (or if blank, box 14) on all T4 slips 
...
Line 9: Contributions through employment (from box 16 and box 17 on all T4 
slips) ^
multiplied by 2 = ^
