...
You cannot claim the WITB if in 2016: 
...
Complete columns 1 and 2 if you had an eligible spouse on December 31, 2016. 
...
Box 392: If you qualify for the disability amount, do you want to claim the 
...
Line 23: Ajusted family net income amount from line 15 on the previous page ^
...
Line 29: Enter the amount from line 7 in column 1 on the previous page. ^
...
Line 34: Amount from line 33 or $514, whichever is less ^
