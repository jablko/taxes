...
For 2019, the Canada workers benefit (CWB) replaces and strengthens the 
...
You cannot claim the CWB for 2019 if any of the following applies to you: 
...
Complete Step 1. The CWB is calculated based on the following amounts: 
...
Line 38102: Are you claiming the basic CWB? 1 Yes or 2 No ^
 
If yes, complete part A and B, then, if applicable, complete Step 2 on page 
4. 
 
Line 38103: If you are eligible for the disability tax credit, do you want to 
...
Line 38104: Is your eligible spouse eligible for the disability tax credit 
for themselves? 1 Yes or 2 No ^
 
If yes, your eligible spouse must complete steps 1 and 3 on a separate 
Schedule 6. 
 
Line 38105: Are you choosing to include tax-exempt income in calculating the 
CWB? (see notes in Part A) 1 Yes or 2 No ^
 
Part A - Working income 
 
Complete columns 1 and 2 if you had an eligible spouse on December 31, 2019. 
...
Line 4 and line 38106: Taxable scholarships, fellowships, bursaries, and 
artists' project grants reported on line 13010 of the return ^
 
Line 5: Total self-employment income reported on lines 13500, 13700, 13900, 
14100, and 14300 of the return (excluding losses) ^
 
Line 6 and line 38107: Tax-exempt working income earned on a reserve reported 
...
Line 7 and line 38108: Add lines 3 to 6. Enter the amount even if the result 
is "0". = ^
...
Column 1 – Your eligible spouse 
 
Line 9: Net income amount from line 23600 of the return ^
 
Line 10 and line 38109: Tax-exempt part of all income earned or received on a 
...
Line 14 and line 38110: Line 12 minus line 13 (if negative, enter "0") = ^
...
You had an eligible spouse or an eligible dependant: less than $36,483 
...
You had an eligible spouse or an eligible dependant: less than $42,316 
...
You had an eligible spouse or an eligible dependant: less than $48,150 
...
Line 34: Enter the amount from line 33 or $700, whichever is less. ^
