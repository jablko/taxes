...
See line 453 in the guide for more information. Complete this schedule, and 
...
In addition, to claim the basic WITB (Step 2), the working income (amount 
...
You cannot claim the WITB if in 2010: 
...
- you were confined to a prison or similar institution for a period of 90 
...
Line 381: Do you have an eligible dependant? 1 Yes or 2 No ^
 
Line 382: Do you have an eligible spouse? 1 Yes or 2 No ^
 
Part A - Working income 
 
Complete columns 1 and 2 if you had an eligible spouse on December 31, 2010. 
Otherwise, complete column 1 only. 
 
Column 1 - You 
 
Line 3: Employment income and other employment income reported on line 101and 
...
Line 391: Are you claiming the basic WITB? 1 Yes or 2 No ^
If yes, complete Step 2 on the next page. 
 
Line 392: Are you claiming the WITB disability supplement for yourself? 1 Yes 
or 2 No ^
If yes, complete Step 3 on the next page. 
 
Line 394: Does your eligible spouse qualify for the disability amount for 
...
Line 16: Enter the amount from line 8 in Step 1. ^
...
Line 23: Enter the amount from line 15 in Step 1. ^
...
Line 28: Line 22 minus line 27 (if negative, enter "0"). = ^
...
Line 34: Enter the amount from line 33 or $465, whichever is less. ^
 
Line 35: Enter the amount from line 15 in Step 1. ^
